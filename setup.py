...
setup(
        ...
        name='Programatic_conf_manip_example',  # Required
        ...
        url='https://github.com/RyanCPeters/UnetVisualized',  # Optional
        ...
        # package_dir={'unet_source': 'unet_source',
        ...
        #
        packages=find_packages(where=str(here)),  # Required
